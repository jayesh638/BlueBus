...
public class HomeController {
   ...
   @PostMapping("/pay")
   public ModelAndView getRedirect(@RequestBody BookingRequest bookingRequest) throws Exception {
    ...
    public ModelAndView getRedirect(HttpServletRequest  httpSession) throws Exception {
        ModelAndView modelAndView = new ModelAndView("redirect:" + paytmDetails.getPaytmUrl());
        TreeMap<String, String> parameters = new TreeMap<>();
